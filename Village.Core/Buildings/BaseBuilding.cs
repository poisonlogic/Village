...
namespace Village.Core.Buildings
{
    public abstract class BaseBuilding : BaseMapStructure, IBuilding
    {
        ...
        public BaseBuilding(string layerName, BuildingDef def, MapSpot anchor, IMapController controller, MapRotation rotation) : base(layerName, def, anchor, controller, rotation)
        {
